...
public class EmailMessage {
	...
	public EmailMessage(String from, String to, String subject, String text,
		...
		this(from, to, subject, text, localServer, localServerPort, false, "", "");
	}

	public EmailMessage(String from, String to, String subject, String text,
			String localServer, int localServerPort, boolean useStartTLS, String username,
